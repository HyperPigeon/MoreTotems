...
public class SummonedDrownedEntity extends DrownedEntity {

    private LivingEntity summoner;

    public SummonedDrownedEntity(EntityType<? extends DrownedEntity> entityType, World world, LivingEntity conjurer) {
